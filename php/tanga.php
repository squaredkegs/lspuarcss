					...
					<li class="dropdown">
					   <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="image/TA.png" title="Thesis Archive" alt="logo" width="28" height="28" border="0"><i class="fa fa-angle-down"></i></a>
						 <ul class="dropdown-menu">
							<li><a href="blog-item.html"><img src="image/logo/gay.png" alt="logo" width="30" height="30" border="0"> Sta. Cruz</a></li>
						   <li><a href="pricing.html"><img src="image/logo/ccc.png" alt="logo" width="30" height="30" border="0"> San Pablo</a></li>
						   <li><a href="404.html"><img src="image/logo/rice.png" alt="logo" width="30" height="30" border="0"> Siniloan</a></li>
						   <li><a href="shortcodes.html"><img src="image/logo/fish.png" alt="logo" width="30" height="30" border="0"> Los Ba単os</a></li>						  </ul>
					</li>
